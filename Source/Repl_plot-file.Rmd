...
```{r Fig1, fig.width = 12, fig.height = 9}
...
This happens directly in the function ecexution (binaries) and seems to be ignored by most people executing and posting their online plots.
